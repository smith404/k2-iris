...
public class LexToken
{
    ...
    /**
     * A flag to indicate if the lemma text should be ignored
     */
    private boolean raw = false;

    public LexToken(String text, String posTag, String lemmaText, String chunkTag, boolean raw, String decoration)
    {
        this.text = text;
        this.posTag = posTag;
    ...
    public String getDecoratedText()
    {
        ...
        {
            return getProcessedLemmaText();
        }
        else if (decoration.contains(decorationPlaceHolder))
        {
            return decoration.replace(decorationPlaceHolder, getProcessedLemmaText());
        }
        else return decoration + getProcessedLemmaText();
    }

    public String getProcessedLemmaText()
    {
        if (raw)
        {
            // If it's raw just return it
            return text;
        }
    ...
    {
        // "O" indicates that no lemma was found so we just return the text
        return lemmaText.startsWith("O") ? text : lemmaText;
    }

    public boolean isLemma()
    {
        return lemmaText.startsWith("O");
    }
